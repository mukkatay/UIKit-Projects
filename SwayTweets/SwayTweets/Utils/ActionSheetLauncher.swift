...
class ActionSheetLauncher: NSObject {
    ...
    private lazy var footerView: UIView = {
        ...
        cancelButton.anchor(left: view.leadingAnchor,
    ...
    func configureTableView() {
        ...
        tableView.register(ActionSheetCell.self, forCellReuseIdentifier: reuseIdentifire)
    }
}
...
extension ActionSheetLauncher: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifire, for: indexPath) as! ActionSheetCell
